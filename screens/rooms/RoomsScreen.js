...
import EditRoomModal from "./EditRoom"; // importar o modal de edição
  ...
  const renderQuarto = ({ item }) => {
    ...
    return (
      <View
        style={[
          styles.card,
          { borderColor: isOcupado ? "#28a745" : "#ffc107" },
        ]}
      >
        <View style={styles.cardHeader}>
          ...
          <View
            style={[
              styles.statusBadge,
              { backgroundColor: isOcupado ? "#d4edda" : "#fff3cd" },
            ]}
          >
            <Text
              style={[
                styles.statusText,
                { color: isOcupado ? "#28a745" : "#ffc107" },
              ]}
            >
