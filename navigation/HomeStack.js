...
export default function HomeStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="UtentesScreen" component={UtentesScreen} options={{ headerShown: false  }} />
      <Stack.Screen name="FuncionarioScreen" component={FuncionarioScreen} options={{ headerShown: false  }} />
      <Stack.Screen name="RelatorioScreen" component={RelatorioScreen} options={{ headerShown: false  }} />
         </Stack.Navigator>
  );
}
